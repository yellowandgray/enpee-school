<header class="header-style-1">
    <!--    <div class="topnav">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-4 float-right social-icon">
    ...
    <nav class="navbar navbar-expand-lg">
        <a class="navbar-brand" href="index.html"><img src="images/logo-np.png" alt=""></a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item"> <a class="nav-link" href="#">Chateau Francais</a> </li>
                <li class="nav-item"> <a class="nav-link" href="#">The Way we Work</a> </li>
                <li class="nav-item"> <a class="nav-link" href="#">What Makes us Different</a> </li>
